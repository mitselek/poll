...
angular.module('entuApp', ['ionic', 'angular.markdown'])
    ...
    .controller('pollCtrl', ['$scope', '$http', '$stateParams', '$ionicLoading', function($scope, $http, $stateParams, $ionicLoading) {
        ...
        $http({
                method : 'GET',
                url    : 'https://poll.entu.ee/api2/entity-' + $stateParams.poll_id,
        ...
        $http({
                method : 'GET',
                url    : 'https://poll.entu.ee/api2/entity-' + $stateParams.user_id,
                params : getSignedData($stateParams.user_id, $stateParams.key, {})
            })
            .success(function(data) {
                $scope.request_count += 1;
        ...
        $http({
                method : 'GET',
                url    : 'https://poll.entu.ee/api2/entity',
            ...
            .success(function(data) {
                ...
                for (var a_idx in data.result) {
                    ...
                    $http({
                            method : 'GET',
                            url    : 'https://poll.entu.ee/api2/entity-' + data.result[a_idx].id,
                            params : getSignedData($stateParams.user_id, $stateParams.key, {})
                        })
                        .success(function(data) {
                            $scope.request_count += 1;
        ...
        $scope.saveNoRating = function(row) {
            ...
            $http({
                method : 'PUT',
                url    : 'https://poll.entu.ee/api2/entity-' + row.id,
